          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?php echo _WEB_ROOT . '/admin/index' ?>" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Home</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?php echo _WEB_ROOT . '/category/list' ?>" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Danh mục sản phẩm</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?php echo _WEB_ROOT . '/products/list' ?>" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Sản phẩm</p>
                  </a>
                </li>
                ...
                <li class="nav-item">
                  <a href="<?php echo _WEB_ROOT . '/slider/list' ?>" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Slider</p>
                  </a>
                </li>
                ...
                <li class="nav-item">
                  <a href="<?php echo _WEB_ROOT . '/bill/list' ?>" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Bill</p>
                  </a>
                </li>
